...
\usepackage[colorlinks=true,linkcolor=HEECnavy,citecolor=darkgray,urlcolor=blue,bookmarks=true,bookmarksnumbered=true,unicode=true,pdftitle={Rapport de Genie Logiciel --- SaaS Directory},pdfauthor={Omar SARSAR, Iliass HARIZ}]{hyperref}
...
{\large\bfseries\color{HEECnavy} Omar SARSAR\\Iliass HARIZ}\\[2cm]
