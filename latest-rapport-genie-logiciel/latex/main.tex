...
\begin{center}
{\color{HEECgold}\rule{0.7\textwidth}{2pt}}\\[1cm]

{\LARGE\bfseries\color{HEECnavy} RAPPORT DE GÉNIE LOGICIEL\\ET CONDUITE DE PROJET}\\[0.5cm]

{\large\color{HEECburgundy} Application des concepts de Génie Logiciel\\et de Conduite de Projet au développement de\\[0.5em]
\textbf{SaaS Directory}}\\[0.8cm]

{\color{HEECgold}\rule{0.5\textwidth}{1pt}}\\[0.8cm]
