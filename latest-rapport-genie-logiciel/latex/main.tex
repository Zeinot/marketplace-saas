...
\begin{tikzpicture}[remember picture,overlay]
  % Top navy banner
  \fill[HEECnavy] (current page.north west) rectangle ([yshift=-3.5cm]current page.north east);
  % Gold accent line below banner
  \draw[HEECgold, line width=2pt] ([yshift=-3.5cm]current page.north west) -- ([yshift=-3.5cm]current page.north east);
...
\begin{center}
{\color{HEECgold}\rule{0.7\textwidth}{2pt}}\\[0.8cm]

{\Large\bfseries\color{HEECnavy} RAPPORT DE GÉNIE LOGICIEL\\ET CONDUITE DE PROJET}\\[0.4cm]

{\large\color{HEECnavy} Application des concepts de Génie Logiciel\\et de Conduite de Projet au développement de\\[0.4em]
\textbf{SaaS Directory}}\\[0.6cm]

{\color{HEECgold}\rule{0.5\textwidth}{1pt}}\\[0.6cm]

{\large\bfseries Module : Génie Logiciel et Conduite de Projet}\\[0.3cm]

{\large\bfseries Encadrant : Pr. Zahid Noureddine}\\[0.8cm]

{\large\bfseries Présenté par :}\\[0.3cm]

{\large\bfseries\color{HEECnavy} Omar SARSAR\\Iliass HARIZ\\Soulaymane ELFAKIR}\\[0.5cm]
