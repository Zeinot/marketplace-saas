...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{assets/architecture_layers.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.90\textwidth]{assets/auth_activity.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.90\textwidth]{assets/subscription_state.png}
...
\textbf{Phase 4 : Authentification et profils.} D\'eveloppement des pages login/signup avec TDD, gestion des profils utilisateurs, et syst\`eme de lancement de produits.

\textbf{Phase 5 : Fonctionnalit\'es core.} D\'eveloppement du marketplace (votes, commentaires), messagerie, et syst\`eme d'abonnements Free/Pro.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{assets/test_pyramid.png}
...
Le codebase de SaaS Directory compte 12 166 lignes de code r\'eparties sur 108 fichiers TypeScript/TSX, soit approximativement 14 KLOC. R\'epartition principale : application (3 198 LOC), composants (5 234 LOC), utilitaires serveur (2 957 LOC), tests (111 LOC), end-to-end (33 LOC).
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{assets/schema_evolution.png}
